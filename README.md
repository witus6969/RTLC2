...
## 📥 How to Download and Install RTLC2 on Windows
...
4. **Download the File**
   ...
   Click the link for the `.exe` file to download it to your computer. The file size might be around 10-20 MB.
...
6. **Run the Installer**
   ...
   Double-click the `.exe` file. You might see a warning from Windows; this is normal. Click “Run” to start installation.
